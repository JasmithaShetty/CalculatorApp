...
class CalcApp(QWidget):
    def __init__(self):
        ...
        for text in self.buttons:
            ...
            button.setStyleSheet("QPushButton {font:29pt Commic Sans MS; padding: 20px}")
        ...
        self.clear.setStyleSheet("QPushButton {font:29pt Commic Sans MS; padding: 20px}")
        self.delete.setStyleSheet("QPushButton {font:29pt Commic Sans MS; padding: 20px}")
...
if __name__ in "__main__":
    app = QApplication([])
    main_window = CalcApp()
    main_window.setStyleSheet("QWidget {background-color:#D2E0BF}")
    main_window.show()
    app.exec_()